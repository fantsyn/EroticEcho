...
const MOOD_FILTERS = [
  ...
  { id: "taboo", label: "Taboo", match: /taboo|forbidden|princess|roommate|veil|palace|wrong house|affair|step/i },
  { id: "public", label: "Public risk", match: /public|elevator|fitting|balcony|closet|exhibition|almost.?caught/i },
