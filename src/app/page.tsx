...
const MOOD_FILTERS = [
  ...
  { id: "peg", label: "Pegging", match: /peg|strap|harness|she tops|role.?reversal/i },
  { id: "piss", label: "Watersports", match: /piss|water.?sport|hold it|shower permission|bladder/i },
  { id: "humil", label: "Humiliation", match: /humiliat|degrad|mirror|say it|quiet filth/i },
  { id: "shy-dom", label: "Shy→dom", match: /shy.?→.?dom|shy.?dom|she leads|practice domme|parking lot domme|stacks: she/i },
  { id: "forbidden", label: "Forbidden", match: /forbidden|taboo|milf|step|affair|home|screenshots|keys in the lock/i },
