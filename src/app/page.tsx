...
const MOOD_FILTERS = [
  ...
  { id: "fantasy", label: "Fantasy", match: /fantasy|monster|magic|sci-fi|worship|demon|vampire|witch/i },
  { id: "power", label: "Power / uniform", match: /power|domme|authority|uniform|office|nurse|cop|boss/i },
